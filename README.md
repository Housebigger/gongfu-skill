...
这是一个从 `Hermes_exploration_diary` 中迁移出来的、以“可复用方法、可积累认知、可共享成果”为核心的知识仓库。它当前保留的重点，不是流水式日记，而是已经沉淀成方法论、主题化转译、经验结晶和伴随式反思的稳定部分。

它也明确服务于一种立场：新技术、新工具、新生产力，不应只成为资本垄断和加剧不公的手段，而应尽可能服务于劳动者成长、社会协作改善与共同富裕目标。

## 仓库宗旨摘要

- 共同富裕不会凭空到来，劳动者需要靠自立、自强、协作与建设，去争取更公平、更有尊严的未来。
- 机器人与人工智能等新生产力，应服务人民、服务劳动者能力提升与社会普惠，而不应沦为资本垄断和加剧不公的工具。
- 本仓库尝试沉淀可复用的方法论、可迁移的认知结构、可积累的经验结晶，为劳动者成长、协作建设与长期共富方向提供支持。
- `methodology/` 负责主题化方法沉淀，`accumulation_settle/` 负责跨文章经验结晶与伴随式反思。

如果你想先快速理解这个仓库为什么叫 `gongfu-skill`，先读这一节；如果你想读更完整、更鲜明的表达，再继续看下面的《共富宣言》。
