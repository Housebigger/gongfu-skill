...
- 当前 `inspiration_on_today_life/indexes/000-mao-anthology-sequential-reading-overview.md` 的顺序覆盖窗口已经推进到 001—113。
...
| 当前已建立原文关联的毛文标题数 | 113 |
| 当前已建立 `原文对应` 的 inspiration 文件数 | 709 |
| 顺序学习已连续覆盖范围 | 001—113 |
| 顺序覆盖段标题核对结果 | 113/113 与 marxists.org 标题一致 |
| 顺序覆盖是否连续 | 是 |
...
- 当前顺序主线已经和 marxists.org 的真实主文章列表对齐到 `113《军队内部的民主运动》`。
- 在 `001—113` 这段里，仓库顺序标题与 marxists.org 原始标题逐条核对一致。
...
| 113 | 《军队内部的民主运动》 | [marxists.org](https://www.marxists.org/chinese/maozedong/marxist.org-chinese-mao-19480130.htm) | 已覆盖（顺序主线，1 个主题转译文件） |

### 2.3 一个简单的覆盖示意图

```text
001—113 顺序主线已建立关联        [#################################################################################################################]
109 《蒋介石政府已处在全民的包围中》 [DONE: 7/7]
110 《目前形势和我们的任务》 [DONE: 7/7]
111 《关于建立报告制度》 [DONE: 7/7]
112 《关于目前党的政策中的几个重要问题》 [DONE: 7/7]
113 《军队内部的民主运动》 [PARTIAL: 1/7]
...
| 113 | 《军队内部的民主运动》 | [原文](https://www.marxists.org/chinese/maozedong/marxist.org-chinese-mao-19480130.htm) | [TL](./inspiration_on_today_life/cooperation_and_organization/113-shared-affairs-get-stronger-when-real-doers-can-speak-help-decide-and-correct.md) | — | — | — | — | — | — | 1 |
...
- 如果要从当前边界继续向下推进，下一篇应是：`114《在不同地区实施土地法的不同策略》`
