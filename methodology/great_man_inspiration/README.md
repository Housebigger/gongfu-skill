...
| 当前已建立原文关联的毛文标题数 | 115 |
| 当前已建立 `原文对应` 的 inspiration 文件数 | 725 |
| 顺序学习已连续覆盖范围 | 001—115 |
...
| 115 | 《纠正土地改革宣传中的“左”倾错误》 | [marxists.org](https://www.marxists.org/chinese/maozedong/marxist.org-chinese-mao-19480211.htm) | 已覆盖（顺序主线，4 个主题转译文件） |
...
115 《纠正土地改革宣传中的“左”倾错误》 [PARTIAL: 4/7]
116 《新解放区土地改革要点》 [NEXT]
```
## 3. 主题缩写图例
