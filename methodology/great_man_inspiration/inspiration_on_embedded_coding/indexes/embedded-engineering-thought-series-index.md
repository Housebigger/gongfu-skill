...
- 为什么真正的工程统一战线，不是只和最同频的人合作，而是把 hardware / driver / test / factory / FAE / field support 里一切能共同顶住主敌的力量组织起来
- 为什么支持面越做宽，越要把主瓶颈、主任务、证据链和质量底线讲清楚
- 为什么外部高压一来，内部总会有人借机攻击工程主线、关键骨干和协作联盟，这时不能装糊涂
- 为什么成熟团队不能只守住内部，还要主动建立第二层、第三层支援面，把窗口、背书、资源和外部协同能力接进来
- 为什么很多时候最大的成熟，不是先把所有旧分歧谈完，而是先围绕共同生存任务把工程队形站住

相关延伸参照：
- `026《抗日游击战争的战略问题》`：长期承压阶段里，要有根据地、主力和灵活空间。
- `029《统一战线中的独立自主问题》`：支持面可以做宽，但工程主判断和主动权不能一起交出去。
- `052《目前抗日统一战线中的策略问题》`：支持面扩出去时，更要稳住主方向和主责任。
- `057《打退第二次反共高潮后的时局》`：暂时缓和不等于真正稳定，要继续识别结构和窗口。
...
- 为什么测试 / 质量 / 工厂 / FAE / 现场支持等真正承担后果的人，必须进入形成层，而不只是被通知和背锅
- 为什么让不同角色把话说完，不是客气，而是防止坏消息、反证和现场摩擦被挡在门外的硬机制
- 为什么“我来负责”如果滑成把持包办，最后常会把项目做成只剩少数人自转的小房子
- 为什么关键权限、版本阀门和核心资源越集中，越要把解释、协商和监督做得更清楚
- 为什么很多深层治理毛病，不能只靠内部复盘，还要把真实合作与外部反馈重新接进来

相关延伸参照：
- `050《新民主主义的宪政》`：治理升级不是换口号，而是真让多数承担者有参与权和共同决定权。
- `051《抗日根据地的政权问题》`：共享治理不能只是旧控制换包装。
- `055《论政策》`：组织复杂协作时，要把统一、斗争、区别和分寸一起带进方法。
- `062《关于反法西斯的国际统一战线》`：支持面做宽以后，更要把主线、主任务和边界讲清。
...
- 为什么板卡、日志、波形、产线、现场和复现场景，必须重新压过远程想象、经验想当然和权限口气
- 为什么硬件 / 驱动 / 测试 / 质量 / 工厂 / FAE / 现场支持之间的关系一旦做成小圈子和权限山头，很多技术问题最后都会退化成解释权与免责空间之争
- 为什么工程八股会让复盘、评审和周报看起来很专业，却持续把真问题、真分歧和真 owner 磨平
- 为什么方法论、平台化和所谓最佳实践必须重新做到“有的放矢”，否则只会变成概念正确但不落地的高级空转
- 为什么真正的团队整风必须落到证据、分歧记录、跨角色发声和关键知识/权限去私有化这些机制里

相关延伸参照：
- `004《反对本本主义》`：没有调查和现场事实，就没有对嵌入式问题下判断的资格。
- `005《纠正错误思想》`：团队内部错误思想不改，组织状态和行动质量会一起跑偏。
- `059《关于调查研究》`：调查不是姿态，而是把判断重新压回真实板卡、产线和现场条件的前提。
- `063《在陕甘宁边区参议会的演说》`：治理做宽以后，更要防止公共事务重新滑回少数核心人私有化。
...
- 为什么术语、资历、原厂背书和核心工程师口气，不能代替当前板卡、日志、波形与现场证据的论证
- 为什么问题单、评审结论、量产汇报和会议纪要都必须看对象来写，不能只写给少数核心工程圈自己看
- 为什么“专业表达”一旦失去现场感、信号感和动作感，就会把团队慢慢训练成只会表演专业而不会推进问题
- 为什么模板、目录和流程完整感只能帮助分析，不能代替对主矛盾、证据强弱和下一步验证动作的拆解
- 为什么反工程八股，不是修文风小毛病，而是在保护嵌入式团队的问题发现能力、跨角色协同能力和组织纠错能力

相关延伸参照：
- `004《反对本本主义》`：没有贴近板卡和现场的调查，再漂亮的说法也可能只是纸面理解。
- `059《关于调查研究》`：一切结论都要重新压回一线材料，不能悬在二手汇报上。
- `064《整顿党的作风》`：主观主义、小圈子协作和工程八股本来就是同一套坏作风在不同层面的表现。
- `063《在陕甘宁边区参议会的演说》`：公共事务要做成真公共，表达也要让不同承担者能进入判断和监督。
...
- 为什么团队必须把产测、测试、返修、工厂、FAE、现场维护这些真实承担者重新当成工作对象，而不是只把他们当成执行末端
- 为什么“不熟不懂，英雄无用武之地”在嵌入式里常常表现为不熟悉现场语言、故障语言、风险语言和交接语言
- 为什么真正值钱的方法源泉不在会议室和架构图里，而在真实板卡、真实产线、真实现场和真实返修摩擦里
- 为什么嵌入式里的“普及和提高”不是先端出最抽象的平台，而是先让真实承担者能进入、能使用、能受益，再从真实交付基础往上提高
- 为什么真正成熟的嵌入式团队，要把少数人的高理解重新翻译成更多角色都能接住、都能推进的工程系统

相关延伸参照：
- `021《中国工人》发刊词`：方向不能漂在真实交付主力之上，必须把真实承压链路组织起来。
- `018《青年运动的方向》`：懂系统的人不是全部主力，先锋认知必须进入现场、产测、交付和维护主力。
- `063《在陕甘宁边区参议会的演说》`：工程公共事务要给不同承担者真实说话和参与位置。
- `065《反对党八股》`：对象、现场和动作一旦从表达里消失，方法很快就会退化成工程八股。
