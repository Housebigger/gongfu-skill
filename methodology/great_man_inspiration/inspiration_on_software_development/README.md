...
这个主题把毛主席相关文章转译成面向现代软件开发的方法论，重点服务于 App、Web、全栈、微信小程序和一般产品工程场景。
...
不处理：
- 固件、驱动、真机 bring-up、板级调试等硬件强耦合问题

那些内容属于 `../inspiration_on_embedded_coding/`。

## 当前实际结构

- `product_strategy/`：4 篇
- `user_research_and_requirements/`：8 篇
...
- 如何避免产品只服务专家自我想象，转而进入真实用户、真实语言与真实工作流
...
- 如何在混乱项目区也从碎片资源、保护窗口和一线经验里建设真实交付产能
...
- 如何识别管理层口中的“准备改革”“以后解决”究竟是在给项目内耗升级、拖字维持还是真实换轨打掩护
...
- 当前这个主题已不再是“预留目录”，而是仓库里体量最大的成熟主题之一
