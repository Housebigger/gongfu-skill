...
那些内容属于 `../inspiration_on_making_money/`。
...
- thesis 搭建与验证
- 如何识别真假转折、真假盟友、真假稳定
- 如何识别管理层口中的“准备改革”“以后解决”究竟是在给 thesis 恶化、拖字维持还是真实修复打掩护
- thesis 如何避免建立在二手纪要、传闻和层层转述上
- 投资学习如何从概念收藏改成研究现状、研究历史和方法落地
...
- 如何研究困难区域里的公司是否能在约束下真实生产，而不是简单否定或盲目买困境故事
