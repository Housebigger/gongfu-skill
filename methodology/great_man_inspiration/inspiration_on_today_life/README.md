...
这个主题把毛主席相关文章转译成“普通人在大变局中的现实生活方法论”。
...
- `judgement_and_decision/`：48 篇
- `long_term_growth/`：11 篇
- `cooperation_and_organization/`：51 篇
- `indexes/`
  - `000-future-mao-originals-implementation-index.md`
  - `000-mao-anthology-sequential-reading-overview.md`

当前合计：137 篇 article-based 笔记；today_life 主题当前实写覆盖为 001—137 已连续对齐。
...
- 如何在新阶段来临前学会研究形势、放下包袱、训练分析习惯，并为更大责任提前做思想与能力准备
- 如何把成长从自我保护和得失计算，升级为对他人有用、对共同体有贡献、对批评能修正的人格方向
...
- 顺序总览窗口当前显示为：`001—131` 已连续对齐完成。
- 如果继续按官网真实顺序向下推进，下一篇应是：`132《关于淮海战役的的作战方针》`。
