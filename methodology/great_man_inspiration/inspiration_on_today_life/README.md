...
当前合计：81 篇 article-based 笔记；today_life 主题当前实写覆盖到 001—081，顺序总览窗口也推进到 081。
...
- today_life 主题当前实写覆盖到：`081《游击区也能够进行生产》`
- 顺序总览窗口当前也推进到：`081《游击区也能够进行生产》`
- 如果继续按 today_life 顺序向下推进，下一篇应是：`082《两个中国之命运》`
